        ...
        where TResponse : BaseCommandResponse
    {
        ...
        public CommandBinder(IMqttConnection connection, string commandName, string componentName = "")
        {
            ...
            connection.OnMessage += async m =>
            {
                ...
                if (topic.StartsWith($"pnp/{connection.ConnectionSettings.DeviceId}/commands/{fullCommandName}"))
                {
                    ...
                    if (OnCmdDelegate != null && req != null)
                    {
                        ...
                        _ = connection.PublishAsync($"pnp/{connection.ConnectionSettings.DeviceId}/commands/{fullCommandName}/resp/{response.Status}/?$rid={rid}", response);
                    }
                }
            };
        }
